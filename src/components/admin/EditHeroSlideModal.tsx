...
const EditHeroSlideModal = ({ slide, isOpen, onClose, onUpdate }: EditHeroSlideModalProps) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-lg font-medium text-gray-900">تعديل الشريحة</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 space-x-reverse pt-4">
            ...
            >
              {loading ? 'جاري التحديث...' : 'تحديث الشريحة'}
            </button>
          </div>
        </form>
      </div>
...
export default EditHeroSlideModal; 